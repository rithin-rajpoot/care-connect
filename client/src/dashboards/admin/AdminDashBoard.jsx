...
import { getAdminProfileThunk, logoutAdminThunk, updateHospitalProfileThunk } from "../../store/slice/hospital/hospitalThunk.js";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button onClick={handleLogout} className="text-gray-500 hover:text-gray-700 cursor-pointer">
                <LogOut size={20} />
              </button>
            </div>
          </div>
